...
class SequenceVisualizer:
	...
	def plot(self, seq1, seq2=None, parallel=False,
		...
		if to_file and create_video:
			...
			mp4_out = join(video_dir, name + '.mp4')
	...
	def plot_in_a_image(self, seq1, seq2=None, parallel=False,
	         plot_fn1=None, plot_fn2=None,
	         parallel_distance=0,
	         views=[(45., 45.)],
	         lcolor2="#E1C200", rcolor2='#5FBF43',
		...
		# n_views = len(views)
		n_views = n
		fig = plt.figure(figsize=(n_views * 4, 15))
		Axs = []
	...
	def plot_in_a_image_file(self, seq1, seq2=None, parallel=False,
	         plot_fn1=None, plot_fn2=None,
	         parallel_distance=0,
	         views=[(45., 45.)],
	         lcolor2="#E1C200", rcolor2='#5FBF43',
		...
		if to_file:
			if n_views > 1:
				fig.savefig(join(seq_root,'out%05d.png' % name),
				            bbox_inches='tight',
				            pad_inches=0, format='png')
...
from fcgan.trainer.forecast_rnn_trainer_nodisc import ForecastRNN_TrainerNoDisc
...
# TRAINER
# ================================
trainer = ForecastRNN_TrainerNoDisc(
...
trainer.run(dl_train, dl_test, optim=[optim1], 
            optim_scheduler=[scheduler1])
